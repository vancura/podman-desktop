...
test.describe('Podman provider creation page navigation', { tag: ['@pdmachine'] }, () => {
...
test.describe('Podman machine switching validation ', { tag: '@pdmachine' }, () => {
  test.describe.configure({ mode: 'serial', timeout: TIMEOUT_AFTER_ALL });
